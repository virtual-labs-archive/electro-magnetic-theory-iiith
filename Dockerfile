...
RUN apt-get install -y make php5 apache2 rsync php5-mysql

RUN mkdir /electro-magnetic-theory-iiith

COPY src/ /electro-magnetic-theory-iiith/src

WORKDIR ./electro-magnetic-theory-iiith/src
