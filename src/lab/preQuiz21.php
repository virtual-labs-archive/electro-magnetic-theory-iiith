...
<font size="3">
<ol>
<li><b>Electric field is ___</b><br>
   <span id="correct1"><input type="radio" name="q1" value="correct">Electric force per unit charge</span><br>
   <input type="radio" name="q1" value="wrong">Electric force per unit distance<br>
   <input type="radio" name="q1" value="wrong">Both<br>
...
<li><b> Electric field due to positive point charge is___</b><br>
   <span id="correct2"><input type="radio" name="q2" value="correct">Radially outwards</span><br>
   <input type="radio" name="q2" value="wrong">Radially inwards<br>
   <input type="radio" name="q2" value="wrong">Does not exist<br>
   <input type="radio" name="q2" value="wrong">None of the above<br>

</li><br />
<hr><br />

<li><b> Electric field due to uniformly distributed line charge is ___</b><br>
   <span id="correct3"><input type="radio" name="q3" value="correct">Proportional to line charge density</span><br>
   <input type="radio" name="q3" value="wrong">Inversely Proportional to line charge density<br>
   <input type="radio" name="q3" value="wrong">Does not depend on line charge density<br>
   <input type="radio" name="q3" value="wrong">None of the above<br>

</li><br />
<hr><br />
<li><b> The direction of electric field due to negative infinite line charge is: </b><br>
   <input type="radio" name="q4" value="wrong">perpendicularly inwardperpendicularly inward<br>
   <span id="correct4"><input type="radio" name="q4" value="correct">perpendicularly  outward</span><br>
   <input type="radio" name="q4" value="wrong">In the direction of line charge<br>
   <input type="radio" name="q4" value="wrong">cannot be determined<br>
</li>
<br />
<hr><br />

<li><b> While calculating electric field due to finite line charge which of the below is correct : </b><br>
   <span id="correct5"><input type="radio" name="q5" value="correct">assuming line charge is made up of point charges we integrate the E field due to all the points</span><br>
   <input type="radio" name="q5" value="wrong">treat whole line charge as  point charge and calculate E field<br>
   <input type="radio" name="q5" value="wrong">E field cannot be determined<br>
