...
<font size="3">
<ol>
<li><b>Coulomb's  law deals with ___</b><br>
   <span id="correct1"><input type="radio" name="q1" value="correct">Force between two electric charges</span><br>
   <input type="radio" name="q1" value="wrong">Force between two masses<br>
   <input type="radio" name="q1" value="wrong">Force between two magnets<br>
   <input type="radio" name="q1" value="wrong">None of the above<br>

</li><br />
<hr><br />

<li><b> One Coulomb charge is the charge on___</b><br>
   <input type="radio" name="q2" value="wrong">6*10<sup>18</sup> electrons<br>
   <input type="radio" name="q2" value="wrong">6*10<sup>18</sup> protons<br>
   <span id="correct2"><input type="radio" name="q2" value="correct">Both above</span><br>
   <input type="radio" name="q2" value="wrong">None of the above<br>

</li><br />
<hr><br />

<li><b> Force on a charge due to other is___</b><br>
   <span id="correct3"><input type="radio" name="q3" value="correct">Proportional to the product of charges</span><br>
   <input type="radio" name="q3" value="wrong">Inversely Proportional to the product of charges<br>
   <input type="radio" name="q3" value="wrong">Both above<br>
   <input type="radio" name="q3" value="wrong">None of the above<br>

</li><br />
<hr><br />
<li><b> Force on a charge due to other is___</b><br>
   <input type="radio" name="q4" value="wrong">Proportional to distance between them<br>
   <span id="correct4"><input type="radio" name="q4" value="correct">Inversely proportional to the square of distance between them</span><br>
   <input type="radio" name="q4" value="wrong">Inversely proportional to the distance between them<br>
