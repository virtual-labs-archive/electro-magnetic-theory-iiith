...
<font size="3">
<ol>
<li><b>Electric flux through any closed surface is equal to ___</b><br>
   <span id="correct1"><input type="radio" name="q1" value="correct">The charge enclosed</span><br>
   <input type="radio" name="q1" value="wrong">Electric field<br>
   <input type="radio" name="q1" value="wrong">Magnetic field<br>
   <input type="radio" name="q1" value="wrong">None of the above<br>

</li><br />
<hr><br />

<li><b> Electrostatic field is ___</b><br>
   <input type="radio" name="q2" value="wrong">Rotational<br>
   <span id="correct2"><input type="radio" name="q2" value="correct">Conservative</span><br>
   <input type="radio" name="q2" value="wrong">Irrotational<br>
   <input type="radio" name="q2" value="wrong">All of the above<br>

</li><br />
<hr><br />

<li><b> Electric field inside a conductor placed in E field is___</b><br>
   <span id="correct3"><input type="radio" name="q3" value="correct">Zero</span><br>
   <input type="radio" name="q3" value="wrong">Infinite<br>
   <input type="radio" name="q3" value="wrong">Cannot be determined<br>
   <input type="radio" name="q3" value="wrong">Depends on the magnitude of field<br>

</li><br />
<hr><br />
<li><b> Boundary conditions are evaluated at___</b><br>
   <span id="correct4"><input type="radio" name="q4" value="correct">Interface of two materials with different dielectric constant</span><br>
   <input type="radio" name="q4" value="wrong">Within the material<br>
